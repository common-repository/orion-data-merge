...
(function(a){"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(c){return a(c,window,document)}):"object"===typeof exports?module.exports=function(c,b){c||(c=window);b&&b.fn.dataTable||(b=require("datatables.net")(c,b).$);return a(b,c,c.document)}:a(jQuery,window,document)})(function(a,c,b,e){function d(){for(var f=a("table.mdc-data-table__table").children(),g=0;g<f.length;g++)if("THEAD"===f[g].tagName){var n=a(f[g]).children();for(var h=0;h<n.length;h++)if("TR"===
n[h].tagName){a(n[h]).addClass("mdc-data-table__header-row");for(var k=a(n[h]).children(),p=0;p<k.length;p++)"TH"===k[p].tagName&&a(k[p]).addClass("mdc-data-table__header-cell")}}else if("TBODY"===f[g].tagName)for(a(f[g]).addClass("mdc-data-table__content"),n=a(f[g]).children(),h=0;h<n.length;h++)if("TR"===n[h].tagName)for(a(n[h]).addClass("mdc-data-table__row"),k=a(n[h]).children(),p=0;p<k.length;p++)"TD"===k[p].tagName&&a(k[p]).addClass("mdc-data-table__cell");}var m=a.fn.dataTable;
